...
output:
  pagedown::html_resume:
    css: ['/shared-scratch/area/sg259480/Markdown_Tutorial/css/custom_resume.css', '/shared-scratch/area/sg259480/Markdown_Tutorial/css/styles_html.css','resume']
    #css: ['/shared-scratch/area/sg259480/Markdown_Tutorial/css/custom_resume.css', '/shared-scratch/area/sg259480/Markdown_Tutorial/css/styles_pdf.css', 'resume']
...
source('/shared-scratch/area/sg259480/Markdown_Tutorial/helper_functions.R')
...
position_data <- read.csv('/shared-scratch/area/sg259480/Markdown_Tutorial/data/position_data.csv', stringsAsFactors = F)
skill_data <- read.csv('/shared-scratch/area/sg259480/Markdown_Tutorial/data/skill_data.csv', stringsAsFactors = F)
```
...
if(params$doctype == "HTML") {
  glue::glue('
    ...
    - <i class="fa fa-github"></i> [github.com/santos-stat](https://github.com/santos-stat)
...
if(params$doctype == "PDF") {
  glue::glue('
    ...
    - <i class="fa fa-github"></i> github.com/santos-stat
...
if(params$doctype == "HTML"){
  cat("[<i class='fas fa-download'></i> Download Docx](https://github.com/santos-stat/Data-driven-repository/raw/main/resume2.docx)")
}
...
if(params$doctype == "HTML") {
  glue::glue("
    ...
    Source code: [**Github repo**](https://github.com/santos-stat/Data-driven-repository).
  ")
} 
if(params$doctype == "PDF") {
  glue::glue("
    Made w/ **pagedown::html_resume**
    Code: **github.com/santos-stat/Data-driven-repository** 
  ")
}
```
